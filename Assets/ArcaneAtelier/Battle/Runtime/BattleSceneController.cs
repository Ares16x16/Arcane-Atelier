...
namespace ArcaneAtelier.Battle
{
    public sealed class BattleSceneController : MonoBehaviour
    {
        ...
        public System.Collections.Generic.List<WorkshopBattleCardEntry> Cards { get; private set; } = new System.Collections.Generic.List<WorkshopBattleCardEntry>();
        ...
        private void LoadWorkshopPayload()
        {
            ...
            {
                // SAVE the cards to our class variable so the UI can see them
